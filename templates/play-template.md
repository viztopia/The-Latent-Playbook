...
# Path to the hero image/video for the play card. Should be in /public/assets/videos/your-play-slug/
heroMedia: '/assets/videos/your-play-slug/hero.jpg'
...
-   Create a corresponding folder for your media assets in `public/assets/videos/`.
-   Use the same slug as your Markdown file (e.g., `public/assets/videos/my-cool-technique/`).
...
-   Reference your media assets using paths relative to the `public` folder (e.g., `/assets/videos/my-cool-technique/example.mp4`).
...
<video controls autoplay loop muted playsinline>
  <source src="/assets/videos/your-play-slug/example-1.mp4" type="video/mp4" />
...
<img src="/assets/videos/your-play-slug/example-image.png" alt="Alt text for the image" style="width:60%;"/>
...
<div class="video-grid">
  <video controls autoplay loop muted playsinline>
    <source src="/assets/videos/your-play-slug/comparison-a.mp4" type="video/mp4" />
  </video>
  <video controls autoplay loop muted playsinline>
    <source src="/assets/videos/your-play-slug/comparison-b.mp4" type="video/mp4" />
  </video>
</div>
